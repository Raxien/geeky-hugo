...
According to data from the {{< extLink "U.S. Department of Transportation" "https://www.transportation.gov/resources/individuals/aviation-consumer-protection/air-travel-consumer-reports-2025" >}}, incidents during pet air transport are **extremely rare: under 0.01%** across the hundreds of thousands of animals transported every year. That's a lower rate than domestic accidents at home.
...
Got a small dog or cat that meets those requirements? We recommend this {{< extLink "cabin carrier" "https://amzn.to/4vm6WcR" >}}, which we also use on buses and trains.

{{< youtube2 1aehU1B-6zI >}}
...
We used this {{< extLink "IATA-compliant carrier" "https://amzn.to/3PYPcVM" >}}. The gold standard if you're travelling by air.
...
| Document | Notes |
|---|---|
| Vaccination passport / health booklet | Up to date |
| Rabies vaccination | Currently valid |
| Antibody titration test | Required by some countries (e.g. Canada, USA) |
| Certificate of good health | Must be issued **within 10 days** of departure |
| Export certificate | Issued by the relevant authorities (in Italy: the ASL) |
| Import certificate | Required by some destination countries |

**Start well in advance**: at least 3-6 months before departure, depending on the destination.

{{< leggi-anche url="https://vandipety.it/blog/viaggiare-cane-gatto-guida-completa" >}}

## How to prepare your pet for the carrier (weeks before the flight)
...
- {{< extLink "Absorbent pad" "https://amzn.to/4fd8KjD" >}} (check the size first)
- Natural pheromone spray ({{< extLink "cat" "https://amzn.to/3RvO9xj" >}} - {{< extLink "dog" "https://amzn.to/4nWzXt6" >}})
- {{< extLink "External tags" "https://amzn.to/3PCh9Ts" >}} with the animal's name and the owner's contact details
- {{< extLink "Water dispenser" "https://amzn.to/4fBiHrt" >}} (check it fits the carrier's door)
- **{{< extLink "AirTag" "https://amzn.to/4e34Bg6" >}}** fixed to the outside with packing tape

**Practical tip**: bring some {{< extLink "zip ties" "https://amzn.to/4vcWJiW" >}} with you to better secure the carrier door. Pack a pair of scissors in your checked suitcase — you'll need them the moment you land to cut them off.
