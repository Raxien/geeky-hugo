...
## A project born three years ago
It was March 2021, and while we waited for [our van](/van) to arrive, we traced routes with our fingers on a big map hanging in the kitchen. It was the time of [Hanami in Japan](/blog/japan-trip-2025-itineraries-guide/), and the photos online full of blooming cherry blossoms made us want to go back to the Land of the Rising Sun. Half-joking, we said to each other:
> **Why don't we go there by van?**

A simple joke, which nonetheless turned into a dream, tucked away in a mental drawer. 
In the meantime the months went by, the dealership finally handed us the keys to the van, we started our first adventures around Italy, and then we spent a whole month on the road in Denmark. 
We came back home, looked into each other's eyes, and said:
...
Our crazy project had to be tucked away in our thoughts once again. 
We decided to set off anyway, just in the opposite direction. We were supposed to head east, to Asia, and we ended up south-west, in Africa.
A bit off route, you might think, but this unplanned adventure taught us so much: we truly learned to live in the van's 9 square metres, to understand its limits, ours, and how to solve the many problems you find yourself facing every day, alone in the middle of the world.

{{< image src="https://res.cloudinary.com/ilgattodicitturin/image/upload/v1760176591/Articoli/viaggi/mappamondo-da-torino-tokyo-pin_ygeiz4.png" title="It seemed closer with a map in hand! Just 8 time zones." >}}

## Good news
Once our adventure in Africa was over (which you can relive [with the interactive map here](/trip/)), while we were heading back [to Italy to get married](/blog/alternative-wedding-30-days-from-a-van/), fix up the van and rethink the road ahead, we got a message from our dear friend Franco of {{<extLink "@bicosisgud" "https://www.instagram.com/bicosisgud/">}}: **"guys, the ferry to Japan is running again!"**
...
Was it time to postpone our project once again? Of course not! 
At that point, map in hand, we simply decided to take the road ahead of us nice and slow, splitting this huge trip into two tours: the first through the Balkan countries to slowly, slowly say goodbye to Europe (which you can see {{<extLink "here" "">}}), the second crossing the threshold of a new continent, **heading for Japan**. 
...
`Update` 
Unlike what we'd originally planned, we've decided to change a few parts of our trip. We've decided to postpone [our visit to Kyrgyzstan](#4-kazakhstan-and-kyrgyzstan) but add [a visit to Saint Petersburg](#3-russia). You'll find the reasons in the dedicated paragraphs below.
...
`Update` 
After finding out [that Olimpia had a tumour](/blog/safe-travels-olimpia/), we decided to skip the 3000+ km detour south and, after visiting Astana, head straight back into Russia instead. We'll leave the visit to Kyrgyzstan for a future trip.
...
We said we'd reveal a few secrets, and we want to keep our word. 
The first is that our destination and our love for Japan have always been right in front of your eyes!

In almost all our videos there's always been a nod to Japan: a ramen restaurant {{<extLink "in the Madrid vlog" "https://youtu.be/MOG3cuPsI_E">}}, a red torii spotted by Sara {{<extLink "in Morocco" "https://youtu.be/bRRphPHpGZ0">}}, or one {{<extLink "Konichiwa too many" "https://youtu.be/asvtCfK9ko8">}}. These are just a few small examples, and we challenge you to find them all!
...
But there's more. You've often asked us what our van is called, and we've always dodged the question, so much so that the community decided to name it **Scricchiolo** ("Creaky", in Italian) because of the damage it picked up during our [Senegal adventure](/blog/senegal-travel-guide-itineraries/).

Now the time has come to reveal to you that our van's real name is:

> ToTo: TOrino-TOkyo (Turin-Tokyo). 

The initials of two cities, the one we started from and the one we're headed to. 
In between: us, the changes of direction, every single emotion we've lived through. 

## Latest updates
One last piece of news to celebrate this big trip! We want to keep everyone happy!

### Vlogs
Throughout April, two vlogs a week will come out on our channel ({{<extLink "subscribe so you don't miss them!" "https://www.youtube.com/channel/UCH3tGEnOnx6ql48zZTSiFvw?sub_confirmation=1">}}) **every Tuesday and Thursday at 6pm!**

### Mini vlogs
Alongside the vlogs there will be "60-second mini vlogs" both on {{<extLink "YouTube as shorts" "https://www.youtube.com/channel/UCH3tGEnOnx6ql48zZTSiFvw?sub_confirmation=1">}} and on {{<extLink "Instagram as reels" "https://www.instagram.com/vandipety/">}}, to tell this big adventure a little more "briefly"!

### Blog
We're officially opening the **[Overlanding to Japan](https://vandipety.it/categories/direzione-giappone)** (in Italian) series, a set of articles where we'll share anecdotes and useful information about this big trip!

What do you say, will you travel with us on this crazy adventure? 

Arigatou, see you next time.

🇮🇹 → 🇯🇵 9862 km (as the crow flies)
