---
title: 'Volare con cane e gatto in stiva: la nostra esperienza (e tutto quello che avremmo voluto sapere prima)'
seo_title: "Volare con cane e gatto in stiva: requisiti, costi e consigli pratici"
...
Secondo i dati del {{< extLink "Department of Transportation degli Stati Uniti" "https://www.transportation.gov/resources/individuals/aviation-consumer-protection/air-travel-consumer-reports-2025" >}}, gli incidenti durante il trasporto aereo di animali sono **estremamente rari: meno dello 0,01%** su centinaia di migliaia di animali trasportati ogni anno. Una percentuale inferiore a quella degli incidenti domestici.
...
Se hai un cane o gatto piccolo che rientra nei requisiti? Consigliamo questo {{< extLink "trasportino da cabina" "https://amzn.to/4vm6WcR" >}} che usiamo anche su autobus e treni.
...
Noi abbiamo usato questo {{< extLink "trasportino conferme alle normative IATA" "https://amzn.to/3PYPcVM" >}}. Il Gold Standard se si viaggia in volo.
...
1. **Chiama la compagnia aerea** e verifica la disponibilità in stiva (i posti sono limitati)
2. **Acquista il biglietto** e riconferma telefonicamente
3. **Comunica** peso dell'animale, peso del trasportino e dimensioni di quest'ultimo
...
- {{< extLink "Tappetino assorbente" "https://amzn.to/4fd8KjD" >}} (verifica le dimensioni)
- Spray ai feromoni naturali ({{< extLink "gatto" "https://amzn.to/3RvO9xj" >}} - {{< extLink "cane" "https://amzn.to/4nWzXt6" >}})
- {{< extLink "Etichette esterne" "https://amzn.to/3PCh9Ts" >}} con nome dell'animale e contatti del proprietario
- {{< extLink "Abbeveratoio per acqua" "https://amzn.to/4fBiHrt" >}} (verificare la compatibilità con lo sportello del trasportino)
- **{{< extLink "AirTag" "https://amzn.to/4e34Bg6" >}}** fissato esternamente con scotch da pacchi

**Consiglio pratico**: porta con te delle {{< extLink "fascette da elettricista" "https://amzn.to/4vcWJiW" >}} per fissare meglio lo sportello del trasportino. Metti un paio di forbici nella valigia che imbarchi — ti serviranno appena atterri per tagliarle.
